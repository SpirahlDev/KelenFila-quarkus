...
-- Schema kelen_fila
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `kelen_fila` DEFAULT CHARACTER SET utf8mb4 ;
USE `kelen_fila` ;

-- -----------------------------------------------------
-- Table `kelen_fila`.`DATABASECHANGELOG`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kelen_fila`.`DATABASECHANGELOG` ;

CREATE TABLE IF NOT EXISTS `kelen_fila`.`DATABASECHANGELOG` (
...
-- -----------------------------------------------------
-- Table `kelen_fila`.`DATABASECHANGELOGLOCK`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `kelen_fila`.`DATABASECHANGELOGLOCK` ;

CREATE TABLE IF NOT EXISTS `kelen_fila`.`DATABASECHANGELOGLOCK` (
  `ID` INT(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `kelen_fila`.`country` (
  ...
  UNIQUE INDEX `unique_country_code` (`country_code` ASC) VISIBLE)
ENGINE = InnoDB
AUTO_INCREMENT = 23
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `kelen_fila`.`person` (
  ...
  `is_identity_card_checked` TINYINT(4) NULL DEFAULT 0,
  `deleted_at` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `email_UNIQUE` (`email` ASC) VISIBLE,
  INDEX `fk_user_country_idx` (`country_id` ASC) VISIBLE,
  INDEX `city_index` (`residence_city` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `kelen_fila`.`account` (
  ...
  `deleted_at` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_account_profile_idx` (`profile_id` ASC) VISIBLE,
  INDEX `fk_account_user_idx` (`person_id` ASC) VISIBLE,
  INDEX `idx_login` (`login` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `kelen_fila`.`administrative_document` (
  ...
  `created_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP(),
  `deleted_at` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`account_id`, `administrative_doc_type`),
  INDEX `fk_administrative_document_doc_type_idx` (`administrative_doc_type` ASC) VISIBLE,
  INDEX `fk_administrative_document_moral_person_idx` (`account_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `kelen_fila`.`category` (
  ...
  UNIQUE INDEX `designCategorie_UNIQUE` (`category_name` ASC) VISIBLE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
CREATE TABLE IF NOT EXISTS `kelen_fila`.`article` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_lot_category_idx` (`category_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `kelen_fila`.`auction` (
  ...
  `bid_collection_id` BIGINT NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `numEnchere_UNIQUE` (`auction_code` ASC) VISIBLE,
  INDEX `FK_ENCHERE_VENDEUR_idx` (`account_owner_id` ASC) VISIBLE,
  INDEX `fk_auction_bid_collection_idx` (`bid_collection_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `kelen_fila`.`moral_person` (
  ...
  `account_id` BIGINT(20) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_moral_person_type_idx` (`moral_person_type_id` ASC) VISIBLE,
  INDEX `fk_moral_person_account_idx` (`account_id` ASC) VISIBLE,
  INDEX `fk_moral_person_country_idx` (`country_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `kelen_fila`.`participant` (
  ...
  `has_join_auction` TINYINT NULL DEFAULT 0,
  `has_actived_notification` TINYINT NULL DEFAULT 0,
  INDEX `fk_user_has_enchere_enchere1_idx` (`auction_id` ASC) VISIBLE,
  INDEX `fk_user_has_enchere_user1_idx` (`account_id` ASC) VISIBLE,
  INDEX `fk_participant_role_idx` (`participant_role_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `kelen_fila`.`collection_article` (
  ...
  INDEX `fk_bid_collection_article_idx` (`bid_collection_id` ASC) VISIBLE,
  INDEX `fk_collection_article_article_idx` (`article_id` ASC) VISIBLE,

...
public enum DomainStatusCode {
    ...
    PASSWORD_MISSING_LOWERCASE("PASSWORD_MISSING_LOWERCASE", "Le mot de passe ne contient pas de minuscules."),
    PASSWORD_MISSING_UPPERCASE("PASSWORD_MISSING_UPPERCASE", "Le mot de passe ne contient pas de majuscules."),
    PASSWORD_MISSING_SPECIAL_CHAR("PASSWORD_MISSING_SPECIAL_CHAR", "Le mot de passe ne contient pas de caractère spéciaux."),
